...
enum StopWatchExecuted { start, stop, reset, lap }
...
class StopWatchTimer {
  StopWatchTimer({
    ...
    _executeController.listen((value) {
      switch (value) {
        case StopWatchExecuted.start:
          _start();
          break;
        case StopWatchExecuted.stop:
          _stop();
          break;
        case StopWatchExecuted.reset:
          _reset();
          break;
        case StopWatchExecuted.lap:
          _lap();
          break;
      }
    });
  ...
  final PublishSubject<StopWatchExecuted> _executeController =
      PublishSubject<StopWatchExecuted>();
  Stream<StopWatchExecuted> get execute => _executeController;
  Sink<StopWatchExecuted> get onExecute => _executeController.sink;
